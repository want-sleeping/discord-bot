...
class Slash_Commands(commands.Cog):
    ...
    @app_commands.describe(which_type="Choose the type of mirror dungeon content you want to see.")
    @app_commands.choices(which_type=[
        app_commands.Choice(name="15 Floor", value="15_floor"),
        app_commands.Choice(name="Ego Gift", value="ego_gift"),
    ...
    async def mirror_dungeon(self, interaction: discord.Interaction, which_type: str):
        if which_type == "15_floor":
